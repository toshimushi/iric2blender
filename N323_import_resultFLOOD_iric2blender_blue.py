...
class ImportResult_iRIC2blender_blue(bpy.types.Operator):
    #ラベル名の宣言
    bl_idname = "object.import_result_blue_iric2blender"
    bl_label = bpy.app.translations.pgettext("3-2-3: import calculation data of Nays2d Flood (Depth / Water)")
    bl_description = bpy.app.translations.pgettext("3-2-3: import calculation data of Nays2d Flood (Depth / Water)")    
