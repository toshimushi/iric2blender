...
class ImportResult_iRIC2blender_velocity_color(bpy.types.Operator):
    #ラベル名の宣言
    bl_idname = "object.import_result_velocity_color_iric2blender"
    bl_label = bpy.app.translations.pgettext("3-2-2: import calculation data of Nays2d Flood (Velocity / Color)")
    bl_description = bpy.app.translations.pgettext("3-2-2: import calculation data of Nays2d Flood (Velocity / Color)")    
    ...
    def execute(self, context):
        ...
        #CSVの読み込み設定
        df_col_list = [2, 3, 5, 6, 8] #Nays2d flood: x,y,depth,z,velocity
